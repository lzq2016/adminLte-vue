  ...
  <div class="wrap">
     <Row style="background-color: #01C0C8;height: 45px;">
        ...
        <Col span="2" style="margin-top: 7px;margin-right: 20px;">
        	<Button type="primary" style="background-color: #01C0C8;border-color: #fff;color:#fff;" @click="search">< 上一周</Button>
        </Col>
        <Col span="9" style="margin-top: 7px;">
            <label style="color: #fff;">当前周:</label>
            <Select v-model="status" style="width: 120px;margin-right: 20px;">
                <Option v-for="item in statusList" :value="item.value" :key="item.value">{{ item.label }}</Option>
            </Select>
            <Button type="primary" style="background-color: #01C0C8;border-color: #fff;color:#fff;" @click="search">下一周 ></Button>
